# -*- coding: utf-8 -*-
"""
Created on Tue Mar 06 15:10:40 2018

Method 2: Share predicted value but not used in the prediction model
...
ax.plot(time48,lux_B1[index],'g',label = 'Actual (48 slots)')
