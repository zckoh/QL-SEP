# -*- coding: utf-8 -*-
"""
Created on Fri Mar 02 13:38:28 2018
...
for x in range(0,days):
    for y in range(0,1440/slot/2):
        #Box 1 predicts
        #use y-1 of Box 2
        EWMA_valb1[x][y] = alpha*(EWMA_valb2[x][y-1]) + (1-alpha)*(float(lux_B1[x-1][y]))
        
        #Box 2 predicts
        #use y of Box 1
        EWMA_valb2[x][y] = alpha*(EWMA_valb1[x][y]) + (1-alpha)*(float(lux_B2[x-1][y]))
